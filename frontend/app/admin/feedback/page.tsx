...
import { Search, ChevronLeft, ChevronRight, Loader2, MessageSquareWarning } from "lucide-react";
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main className="flex-1 overflow-y-auto px-8 py-8 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
